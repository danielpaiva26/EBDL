...
Nom programme: EBDL Promotion

Date creation: 23/11/2012 16:48

Date modif: 07/02/2013 18:07
...
<div id="conteneur">
  ...
  <!-- Sous menu vert -->
    ...
    <div class="titre_set">:: Ma Promotion</div>

    <?php promotion_page($id,$_GET['tri']); ?>
